...
window.PM_SHEET = {
  ...
  pmType: "ASM Tubechange", // kleiner Untertitel unter dem Titel
  ...
  sections: [
    {
      ...
      steps: [
        ...
        { text: "Do a Leak check for later Reference" },
    ...
    {
      title: "Change the Boat (optional if the counter is > half of Boat lifetime)",
      steps: [
        { text: "Prepare polyflow for parts cleaning" },
        { text: "Rotate to and remove first Boat and Pedestal from service door station" },
        { text: "Lower second boat down from reactor"},
        { text: "Move Boat from under the Reactor to Cooling Station to cool" },
        { text: "Once cooled, remove boat through service Door" },
      ],
    },
    {
      title: "Remove Tube",
